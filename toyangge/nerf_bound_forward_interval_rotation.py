...
if __name__ == "__main__":
    ...
    n_iters=100000
    chunksize = 2**5
    eps=angle_step=0.00018
    angle_start,angle_end=4.290,4.30#angle_step*3#
    # cur_angle=angle=0.2
    ...
    if save_npz:
        ...
        output_feature=str(dataname)+"_"+str(angle_start).split(".")[0]+"-"+str(angle_start).split(".")[1]+\
            "_"+str(angle_end).split(".")[0]+"-"+str(angle_end).split(".")[1]+"_step_"+str(angle_step).split(".")[1]
